...
/****************************************************************************/
/* Показывает метрики для операторов хранимых процедур, т.е функций,        */
/* триггеров, других хранимых процедур, вызываемых из родительской          */
/* Вместо <SP Name> нужно указать название конкретной хранимой прецедуры    */
...
WHERE
OBJECT_NAME(qt.objectid, qt.dbid) = '<SP Name>' -- Замените на имя хранимой процедуры
ORDER BY
